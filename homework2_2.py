...
n0 = "1,1,r; 1/(0+2^2+1)=1/5;"
n01 = "1,2,r; 1/(1+1^2+1)=1/3;"
n02 = "1,1,u; 1/(1+2^2+0)=1/5;"
n03 = "1,1,d; 1/(1+2^2+2)=1/7;"
graph_a.add_edge(pydot.Edge(n0,n01))
graph_a.add_edge(pydot.Edge(n0,n02))
graph_a.add_edge(pydot.Edge(n0,n03))
n011 = "1,3,r; 1/(2+2^2+1)=1/7"
n012 = "1,2,u; 1/(2+1^2+0)=1/3"
n013 = "1,2,d; 1/(2+1^2+2)=1/5"
